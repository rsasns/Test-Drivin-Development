<?php
namespace tests\chapter15;

use PHPUnit\Framework\TestCase;
use src\chapter15\Bank;
use src\chapter15\Money;
use src\chapter15\Sum;
...
Class MoneyTest extends TestCase
{
    ...
    {
        $five = Money::dollar(5);
        /** @var \src\chapter15\Expression $result */
        $result = $five->plus($five);
        /** @var \src\chapter15\Sum $sum*/
        $sum = $result;
